...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align="left" font='outfit' title='Dashboard' subTitle='Moniter your room listings, track bookings and analyze revenue-all in one place. Stay updated with real-time insights to ensure smooth operations  ' />

      <div className='flex gap-4 my-8'>
        {/* Total Bokings */}
        <div className='bg-primary/3 p-4 pr-8 border border-primary/10 flex rounded'>
        ...
        {/* Total Revenue */}
        <div className='bg-primary/4 p-4 pr-8 border border-primary/10 flex rounded mr-4'>
