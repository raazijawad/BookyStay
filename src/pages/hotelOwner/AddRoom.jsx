      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4 '>
        <div className='flex-1 max-w-48'>
          ...
          <select value={inputs.roomType} onChange={e=> setInputs({...inputs, roomType: e.target.value})}
            className='w-full border border-gray-300 p-2 mt-1 opacity-70'>
        ...
        <div>
          ...
          <input type="number" placeholder='0' className='border border-gray-300 p-2 mt-1 rounded w-24' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs, pricePerNight: e.target.value})}/>
        </div>
      </div>
